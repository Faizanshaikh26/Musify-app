...
function Player() {
  const {
    ...
    seekBg,
    seekRing,
    audioRef, // Use the audioRef from the context
  } = usePlayer();
      ...
      <div className="p-2 pb-0 sm:p-4 sm:pb-3 lg:p-2 lg:pb-1 xl:p-4 xl:pb-3 space-y-2 sm:space-y-4 lg:space-y-2 xl:space-y-4 items-center">
        ...
        <div className="space-y-0 md:space-y-[-30px] lg:ml-[20%] ">
          ...
          <div className="flex justify-end lg:right-[15%] lg:top-[94px] md:left-[30%] md:top-16 absolute top-[10px] right-[7px] gap-3 text-slate-200">
            <i className="fa-solid fa-backward text-[20px] lg:text-[27px] cursor-pointer" onClick={previousTrack}></i>
            {isPlaying ? (
              <i className="fa-solid fa-pause text-[20px] lg:text-[27px] cursor-pointer" onClick={pause}></i>
            ) : (
              <i className="fa-solid fa-play text-[20px] lg:text-[27px] cursor-pointer" onClick={play}></i>
            )}
            <i className="fa-solid fa-forward text-[20px] lg:text-[27px] cursor-pointer" onClick={nextTrack}></i>
